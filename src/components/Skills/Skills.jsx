...
const Skills = () => {
  return (
    <section
      id='skills'
      className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans skills-gradient clip-path-custom'
    >
      {/* Section title */}
          ...
          >
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 w-full gap-3'>
              {category.skills.map((skill) => (
                <div
                  key={skill.name}
                  className="flex items-center justify-center space-x-2 bg-transparent border-2 border-gray-700 rounded-3xl py-4 px-4 sm:py-4 sm:px-4 text-center"
